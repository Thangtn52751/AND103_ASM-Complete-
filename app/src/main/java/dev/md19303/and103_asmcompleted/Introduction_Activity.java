...
import dev.md19303.and103_asmcompleted.Adapter.CardAdapter;
import dev.md19303.and103_asmcompleted.Model.CardData;
...
public class Introduction_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Introduction_Activity.this, LoginActivity.class);
